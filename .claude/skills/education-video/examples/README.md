...
while there is only one. What becomes of a film when the skills are lifted out is in
[`../../_shared/README.md`](../../_shared/README.md) and is not restated here: that answer has
...
[`../showoff/assembly/audio/AUDIO-LOG.md`](../../showoff-render/examples/assembly/audio/AUDIO-LOG.md) is what skipping that cost.
