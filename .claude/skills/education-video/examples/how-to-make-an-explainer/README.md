...
| 5 | `references/explainer-picture/` | the HTML bundles it returned — as delivered, and the captions-off copy that was rendered. Moved out of this film's folder on 2026-08-22: they are 53 MB, no skill reads them, and they no longer travel with an install. Not linked, because `references/` is not copied into a target project |
...
[`../../picture/export_html_video.py`](../../method/export_html_video.py), which needs the **default**
