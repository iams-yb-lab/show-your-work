...
# Walk up to the skills root rather than counting directories; this tree moved once already.
SKILLS = next(p for p in ROOT.parents
              if (p / "_shared").is_dir() and (p / "natural-voice").is_dir())
REPO = SKILLS.parents[1]
EDUCATION = SKILLS / "education-video" / "examples" / "intro"
