...
| `references/assembly-gallery/` | the four committed stills. Moved there on 2026-08-22: 33 MB, no skill reads them, and three of the four were named by no file. Not linked, because `references/` is not copied into a target project |
