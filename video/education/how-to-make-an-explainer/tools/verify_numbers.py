...
VIDEO = video_root(Path(__file__).resolve())
REFERENCE_SCRIPT = VIDEO / "education/intro/script/voiceover-script.md"
REFERENCE_MEDIA = VIDEO / "education/intro/picture/Temperature Controller Intro 1080p.mp4"
