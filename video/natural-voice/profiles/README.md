...
The shared production method is [`../README.md`](../README.md). Film-specific
takes, stems and mixes belong under `video/out/<film>/`; film-specific generation scripts and reports belong
